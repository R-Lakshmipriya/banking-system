...
<html lang="en">
  ...
  ?>
      ...
      <!-- Activity section -->
            <div class="row activity text-center" style="background-color: #faebd7;">
                  <div class="col-md act">
                    <img src="img/banking-1.jpg" class="img-fluid" style="height:250px;">
                    <br>
                    <a href="transfermoney.php"><button style="background-color : #008080;">Transaction</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/banking-2.jpg" class="img-fluid" style="height:250px;">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
            <p>&copy Made by <b>R.LAKSHMI PRIYA</b></p>
      </footer>
